...
- Providing regex-based exclusion rules for selective PDB management
...
| `config.additionalSelectorLabels` | YAML list of additional labels to add to the PDB Selector | `[]` (empty) |
